...
//        let width = (self.view.frame.width - 44) / 4
        var x = (self.view.frame.width - 200) / 2
        let y = (self.view.frame.height - 200) / 2
        
        // star button
        let starButton = DOFavoriteButton(frame: CGRectMake(x-side, y-side, 200, 200), image: UIImage(named: "star"))
...
//        x += width
        ...
        // heart button
        let heartButton = DOFavoriteButton(frame: CGRectMake(x+side, y-side, 200, 200), image: UIImage(named: "heart"))
...
//        x += width
        ...
        // like button
        let likeButton = DOFavoriteButton(frame: CGRectMake(x-side, y+side, 200, 200), image: UIImage(named: "like"))
...
//        x += width
        ...
        // smile button
        let smileButton = DOFavoriteButton(frame: CGRectMake(x+side, y+side, 200, 200), image: UIImage(named: "smile"))
